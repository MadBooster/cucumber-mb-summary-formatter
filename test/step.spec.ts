...
describe('Step', () => {
  ...
  it('warns about ambiguous steps', async () => {
    ...
    result.should.containEql(
      ...
      '         ambiguous - test/features/support/steps.ts:9 \n'+
      '         ambiguous - test/features/support/steps.ts:10\n'+
      '\n'+
  ...
  it('warns about failed steps', async () => {
    ...
    result.should.match(new RegExp(
      ...
      '   ✖ When failed # test/features/support/steps.ts:11\\n'+
      '       Error: FAILED\\n'+
  ...
  it('logs pending steps', async () => {
    ...
    result.should.containEql(
      ...
      '   ? When pending # test/features/support/steps.ts:15\n'+
      '       Pending\n'+
      '\n'+
  ...
  it('logs docString errors', async () => {
    ...
    result.should.match(new RegExp(
      ...
      '   ✖ Given failing doc string: # test/features/support/steps.ts:18\\n'+
      '       Error: FAILED\\n'+
      '           at World\\.<anonymous> \\(.*:\\d+:\\d+\\)\\n'+
      '\\n'+
      '1 scenario \\(1 failed\\)\\n'+
  ...
  it('logs dataTable errors', async () => {
    ...
    result.should.match(new RegExp(
      ...
      '   ✖ Given failing data table: # test/features/support/steps.ts:22\\n'+
      '       Error: FAILED\\n'+
      '           at World\\.<anonymous> \\(.*:\\d+:\\d+\\)\\n'+
      '\\n'+
      '1 scenario \\(1 failed\\)\\n'+
