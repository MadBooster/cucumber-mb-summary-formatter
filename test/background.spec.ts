...
describe('Background', () => {
  ...
  it('logs backgrounds on failed step', async () => {
    ...
    result.should.match(new RegExp(
      ...
      '   ✔ Given noop # test/features/support/steps.ts:7\\n'+
      '   ✖ Given failed # test/features/support/steps.ts:11\\n'+
      '       Error: FAILED\\n'+
  ...
  it('logs failing backgrounds', async () => {
    ...
    result.should.match(new RegExp(
      ...
      '       Error: FAILED\\n'+
      '           at World\\.<anonymous> \\(.*:\\d+:\\d+\\)\\n'+
      '   - When noop # test/features/support/steps.ts:7\\n'+
      '   - Then noop # test/features/support/steps.ts:7\\n'+
      '\\n'+
      '1 scenario \\(1 failed\\)\\n'+
